...
<label className='flex flex-col'>
  ...
  <a
    href="https://github.com/TanSingsukhum"
    target='_blank'
  ...
  <a
    href="https://www.instagram.com/tanx_thanaphon/"
    target='_blank'
    rel='noopener noreferrer'
    className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium cursor-pointer inline-flex items-center gap-2'
  >
    {/* Add Instagram icon here if you have one */}
  ...
  <a
    href="https://www.linkedin.com/in/thanaphon-singsukhum-98b074271/"
    target='_blank'
    rel='noopener noreferrer'
    className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium cursor-pointer inline-flex items-center gap-2'
  >
